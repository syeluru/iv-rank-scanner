"""
Fetch SPXW term structure from ThetaData for v1_2.

Pulls EOD option data across 4 expiry buckets (0, 7, 14, 30 DTE)
for 15 strike offsets around ATM. Uses parallel requests.

Source: ThetaData localhost:25503
Output: raw/v1_2/spxw_term_structure.parquet

Columns: date, expiration, dte, strike, right, spx_close, atm_strike,
         moneyness, bid, ask, mid, volume

Run modes:
  python fetch_term_structure_v1_2.py              # fetch missing dates
  python fetch_term_structure_v1_2.py --days 5     # only last N days
"""
...
def main():
    ...
    # Use v1_2 SPX daily for price lookups
    ...
    outfile = RAW_V1_2 / "spxw_term_structure.parquet"
    all_rows = []
    complete_dates = set()
