...
**Important:** Read `model_documentation_v1_2.md` for the current model design decisions, assumptions, target logic, feature inventory, split methodology, and evaluation approach. That document is the source of truth for how the model works and why. (`model_documentation_v1.md` is the archived V1 version.)
