"""
Build technical indicator features on top of the merged SPY table.
Reads: data/spy_merged.parquet
Saves: data/spy_features.parquet
...
def main():
    ...
    df = pd.read_parquet(DATA_DIR / "spy_merged.parquet")
    ...
    outfile = DATA_DIR / "spy_features.parquet"
